### reference link : https://rpubs.com/renrele/loanpred

train <-read.csv("C:/Users/Swagger/Desktop/Hadoop/R code/Loan Pred/Data/train_u6lujuX_CVtuZ9i.csv",na.strings = c(""," ",NA))
test <-read.csv("C:/Users/Swagger/Desktop/Hadoop/R code/Loan Pred/Data/test_Y3wMUE5_7gLdaTN.csv",na.strings = c(""," ",NA))
